import {RowKey, RowSelection, TableData} from './interface'
...
export function useListSelected(data: TableData, rowSelection: RowSelection, emit: any) {
  ...
  rowSelection && useSetSelectedProp(data, (rowSelection as RowSelection).selectedRowKeys)
